# DevTips-Starter-Kit Gulp Version with Compass

I've used [Gulp DevTips Starter Kit](https://github.com/mriverodorta/DevTips-Starter-Kit/archive/Gulp-Starter-Kit.zip) and edited for using compass for sass.
